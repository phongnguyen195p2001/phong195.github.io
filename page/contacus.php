...
<section class="bg-white py-8">
    <nav class="mx-auto my-4 px-2 container" aria-label="Breadcrumb">
        <ol class="list-none p-0 block" vocab="https://schema.org/" typeof="BreadcrumbList">
            ...
            <li property="itemListElement" typeof="ListItem" class="inline items-center pr-2">
                <a property="item" typeof="WebPage" title="" href="/page/aboutus.php"
                   class="text-primary hover:text-secondary">
                    <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"
                         stroke-linejoin="round" class="inline-block h-4 w-4 -mr-2">
                        <polyline points="9 18 15 12 9 6"></polyline>
                    </svg> &nbsp;
                    <span property="name">Liên hệ</span> </a>
            ...
            <div id="sidebar" class="hidden lg:block col-span-12 lg:col-span-3">
                <div class="m-2">
                    <ul>
                        ...
                        <li class="mb-3 lg:mb-1"><a
                                    class="px-2 -mx-2 py-1 transition-fast relative block hover:translate-r-2px hover:text-gray-900 text-gray-900 not-italic"
                                    href="/page/contacus.php" data-path="contact-us"> <span
                                        class="rounded absolute inset-0 bg-teal-200 opacity-0"></span> <span
                                        class="relative">Liên hệ</span> </a></li>
                    </ul>
                </div>
            </div>
            <div id="content-wrapper" class="col-span-12 md:col-span-9">
                <div class="m-2">
                    <article class="prose prose-sm sm:prose max-w-none mx-auto"><h1>Liên hệ</h1>
                        ...
                        <p>Nếu bạn có vấn đề cần hỗ trợ, vui lòng liên hệ với chúng tôi qua các thông tin sau: (Làm
                            việc: 24/7 )</p>
                        <p>Email: <strong><a href="mailto:info@5pdf.net.org">info@5pdf.net</a></strong></p>
                        <p>Số điện thoại: <strong>+84 876776444</strong></p>
                        <p>Fax: <strong>+84 876776444</strong></p>
                        <p>Địa chỉ: <strong>Tòa nhà Sông Đà, đường Phạm Hùng, Mỹ Đình 1, Quận Nam Từ Liêm, Hà Nội, Việt
                                Nam</strong></p>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14897.504056851367!2d105.7809957!3d21.0176356!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x35ac90387f094f93!2zVMOyYSBuaMOgIFPDtG5nIMSQw6A!5e0!3m2!1svi!2s!4v1624530213767!5m2!1svi!2s"
                                width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        <div class="social__container">
                            <div class="social__item"><a target="_blank" href="https://www.linkedin.com/in/5pdfnet/"
                                                         class="social__icon--linkedin"><i
                                            class="icon--linkedin"></i></a></div>
                            <div class="social__item"><a target="_blank" href="https://twitter.com/5pdfNet"
                                                         class="social__icon--twitter"><i class="icon--twitter"></i></a>
                            </div>
                            <div class="social__item"><a target="_blank" href="https://sites.google.com/view/5pdfnet/"
                                                         class="social__icon--google"><i class="icon--google"></i></a>
                            </div>
                            <div class="social__item"><a target="_blank" href="https://www.facebook.com/5pdf.net"
                                                         class="social__icon--facebook"><i
                                            class="icon--facebook"></i></a></div>
                            <div class="social__item"><a target="_blank" href="https://www.pinterest.com/5pdf/"
                                                         class="social__icon--pintrest"><i
                                            class="icon--pintrest"></i></a></div>
                            <div class="social__item"><a target="_blank"
                                                         href="https://www.youtube.com/channel/UC7xWWiOsTeQxjbKaNFJvHxw/about"
                                                         class="social__icon--youtube"><i class="icon--youtube"></i></a>
                            </div>
                        </div>
                    </article>
                </div>
